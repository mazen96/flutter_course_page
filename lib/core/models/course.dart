...
class Course {
  ...
  @override
  String toString() {
    return 'Course{id: $id, title: $title, img: $img, interest: $interest, price: $price, date: $date, address: $address, trainerName: $trainerName, trainerImg: $trainerImg, trainerInfo: $trainerInfo, occasionDetail: $occasionDetail, latitude: $latitude, longitude: $longitude, isLiked: $isLiked, isSold: $isSold, isPrivateEvent: $isPrivateEvent, hiddenCashPayment: $hiddenCashPayment, specialForm: $specialForm, questionnaire: $questionnaire, questExplanation: $questExplanation, reservTypes: $reservTypes}';
  }
